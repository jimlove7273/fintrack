...
export default function AccountPage({
  ...
  // Calculate balances
  const accountBalance = calculateAccountBalance(accountId, transactions);
  ...
  return (
    <ProtectedRoute>
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-4 flex justify-end">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-2 md:mb-0">
              ...
              <div className="flex items-center">
                ...
                <select
                  ...
                  className="block w-16 md:w-24 pl-2 pr-6 py-1 md:pl-3 md:py-2 text-xs md:text-sm border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 rounded-md"
                >
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {paginatedTransactions.length === 0 ? (
                ...
                paginatedTransactions.map((transaction) => (
                  ...
                  >
                    <td className="px-4 py-2 md:px-6 md:py-4 whitespace-nowrap text-xs md:text-sm text-[#0a0a0a]">
